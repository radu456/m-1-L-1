const CACHE_NAME='after-school-lectia-5-v2';
const CACHE_PREFIX='after-school-lectia-5-';
const ASSETS=['./','./index.html','./styles/style.css','./app.js','./manifest.json','./icon.svg'];
